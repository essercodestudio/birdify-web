  ...
  const openDetails = async (t) => {
    try {
      ...
      if (alreadySubscribed && fullTournamentData.whatsapp_contact) {
        ...
        const cleanNumber = fullTournamentData.whatsapp_contact.replace(
          /\D/g,
          "",
        );
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.tabsContainer}>
        <button
          style={styles.tabBtn(activeTab === "ativos")}
          onClick={() => setActiveTab("ativos")}
        >
          🟢 ABERTOS
        </button>
        <button
          style={styles.tabBtn(activeTab === "concluidos")}
      ...
      {activeTab === "ativos" ? (
        <div>
          {activeTournaments.length === 0 ? (
            ...
            >
              Nenhum torneio Birdify aberto no momento.
            </div>
          ) : (
            activeTournaments.map((t) => (
              ...
              >
                ...
                >
                  <h3 style={{ margin: "0 0 5px 0", color: theme.gold }}>
                    {t.name}
                  </h3>
        ...
        <div>
          {pastTournaments.map((t) => {
            ...
            return (
              ...
              >
                <h3 style={{ margin: "0 0 5px 0", color: theme.danger }}>
                  {t.name}
                </h3>
                <p
                  style={{
                ...
                >
                  Clique para ver o Hall da Fama e resultados.
                </p>
              </div>
            );
          })}
      ...
      {selectedTournament && (
        <div style={styles.modalOverlay} onClick={closeModal}>
          <div style={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            ...
            >
              <h2 style={{ marginTop: 0, marginBottom: 0, color: theme.gold }}>
            ...
            <div style={styles.infoBox}>
              ...
              >
                <p style={{ margin: "0 0 5px 0" }}>
                  ...
                  {formatDateTime(selectedTournament.start_date)}
                </p>
                <p style={{ margin: 0, color: theme.danger }}>
                  ⏳ <strong>Prazo Final:</strong>{" "}
                  {formatDateTime(selectedTournament.registration_deadline)}
                </p>
              </div>
            </div>
            ...
            {selectedTournament.payment_info && (
              <div
                style={{
                  ...styles.infoBox,
                  borderLeft: `4px solid ${theme.whatsapp}`,
                }}
              >
            ...
            {!isSubscribed ? (
              ...
              >
                ...
                <h3 style={{ margin: "0 0 5px 0", color: theme.accent }}>
                ...
                >
                  Efetue o pagamento na chave PIX acima e envie o comprovante
              ...
              >
                ...
                >
                  <img
                    ...
                    src={
                      selectedTournament.sponsors[currentSponsorIndex].image_url
                    }
                    alt={
                      selectedTournament.sponsors[currentSponsorIndex].name ||
                      "Patrocinador"
                    }
                    style={{
                      maxHeight: "100%",
